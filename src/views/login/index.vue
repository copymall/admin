        ...
        <el-card class="login-form-layout">
            <el-form autoComplete="on"
                ...
                <div style="text-align: center">
                    <svg-icon name="login-mall" style="width: 56px;height: 56px;color: #409EFF"></svg-icon>
                </div>
                ...
                <el-form-item prop="username">
                    <el-input name="username"
                              ...
                              placeholder="请输入用户名">
          <span slot="prefix">
            <svg-icon name="user" class="color-main"></svg-icon>
          </span>
                    </el-input>
                </el-form-item>
                <el-form-item prop="password">
                    <el-input name="password"
                              ...
                              placeholder="请输入密码">
          <span slot="prefix">
            <svg-icon name="password" class="color-main"></svg-icon>
          </span>
                        <span slot="suffix" @click="showPwd">
            <svg-icon name="eye" class="color-main"></svg-icon>
          </span>
                    </el-input>
                </el-form-item>
