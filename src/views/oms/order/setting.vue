<template>
    <el-card class="form-container" shadow="never">
        <el-form :model="orderSetting"
                ...
                :rules="rules"
                label-width="150px">
            <el-form-item label="秒杀订单超时：" prop="flashOrderOvertime">
            ...
            <el-form-item label="正常订单超时：" prop="normalOrderOvertime">
            ...
            <el-form-item label="发货超时：" prop="confirmOvertime">
            ...
            <el-form-item label="订单完成超时：" prop="finishOvertime">
            ...
            <el-form-item label="评论完成超时：" prop="commentOvertime">
...
<script>
    import {getOrderDetail,updateOrderSetting} from "../../../api/order";
