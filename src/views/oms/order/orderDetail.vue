    ...
    <div class="detail-container">
        ...
        <el-card shadow="never" style="margin-top: 15px">
            <div class="operate-container">
                ...
                <div class="operate-button-container" v-show="order.status===0">
                    ...
                    <el-button size="mini" @click="alertGoodsInfo">修改商品信息</el-button>
            ...
            <div class="table-layout">
                <el-row>
                    ...
                    <el-col :span="4" class="table-cell-title">用户账户</el-col>
            ...
            <div style="margin-top: 20px">
                <svg-icon class="marker" style="color: #606266"></svg-icon>
            ...
            <div class="table-layout">
                ...
                <el-row>
                    ...
                    <el-col :span="6" class="table-cell">￥{{order.inntegrationAmount}}</el-col>
                </el-row>
        ...
        <el-dialog title="修改收货人信息"
            ...
            <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="handleUpdateReveiverInfo">确定</el-button>
            </span>
        </el-dialog>
        ...
        <el-dialog  title="修改费用信息"
            ...
            <div class="table-layout">
                ...
                <el-row>
                    <el-col :span="6" class="table-cel">￥{{order.totalAmount}}</el-col>
                    <el-col :span="6" class="table-cel">
                        <el-input v-model.number="moneyInfo.freightAmount" size="mini">
                            <template slot="prepend">￥</template>
                        </el-input>
                    </el-col>
                    <el-col :span="6" class="table-cel">￥{{order.couponAmount}}</el-col>
                    <el-col :span="6" class="table-cel">￥{{order.integrationAmount}}</el-col>
                </el-row>
            ...
            <span slot="foot" class="dialog-foot">
                <el-button @click="moneyDialogVisible=false">取消</el-button>
                <el-button type="primary" @click="handleUpdateMoneyInfo">确定</el-button>
            </span>
        </el-dialog>
        ...
        <el-dialog
            ...
            <el-form :model="message"
                ...
                <el-form-item label="内容：">
                    <el-input v-model="message.content" type="textarea" raws="3"></el-input>
                </el-form-item>
        ...
        <el-dialog
            ...
            <el-form :model="closeInfo" label-width="150px">
                <el-form-item label="操作备注">
                    <el-input v-model="closeInfo.not" type="textarea" rows="3"></el-input>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
