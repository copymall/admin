        ...
        <el-form ref="productAttrFrom"
            ...
            <el-form-item label="属性值的录入方式：">
                <el-radio-group v-model="productAttr.inputType">
                    ...
                    <el-radio :label="2">从下面列表中选择</el-radio>
                </el-radio-group>
            </el-form-item>
...
<script>
    ...
    export default {
        ...
        methods:{
            getCateList(){
                let listQuery = {pageSize:5, pageNum:1};
                    ...
                    if(valid){
                        this.$confirm('是否提交数据', '提示', {
                           ...
                           if(this.isEdit) {
                               ...
                               createProductAttr(this.$route.query.id, this.productAttr).then(response=>{
                                   this.$message({
                                       message: '提交成功',
                                       type: 'success',
                                       duration: 1000
