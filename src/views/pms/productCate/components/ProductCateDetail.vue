    ...
    <el-card class="form-container" shadow="never">
        <el-form ref="productCateFrom"
            ...
            <el-form-item label="上级分类：">
                <el-select  placeholder="请选择分类" v-model="productCate.parentId">
        ...
        methods: {
                    ...
                    for (let i = 0; i < list.length; i++) {
                        ...
                        if(productAttrCate.productAttributeList != null && productAttrCate.productAttributeList.length > 0) {
                            for (let j = 0; j < productAttrCate.productAttributeList.length; j++) {
                                children.push({label:productAttrCate.productAttributeList[j].name, value: productAttrCate.productAttributeList[j].id});
                            }
                        }
            ...
            getProductAttributeIdList(){
                ...
                for (let i = 0; i < this.filterProductAttrList.length; i++) {
                    ...
                    if(item.value!==null&&item.length === 2){
