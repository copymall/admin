    ...
    <div style="margin-top: 50px">
        <el-form
            ...
            <el-form-item v-show="value.promotionType===1">
                ...
                <div class="littleMargin">
                    促销价格：
                    <el-input style="width: 220px" placeholder="输入促销价格" v-model="value.promotionPrice"></el-input>
                </div>
            </el-form-item>
    ...
    export default {
        ...
        computed: {
            selectServiceList: {
                get() {
                    let list = [];
                    if (this.value.serviceIds === undefined
        ...
        methods: {
            ...
            handleAddProductLadder(index, row) {
                ...
                if(productLadderList.length < 3) {
                    productLadderList.push({count:0, discount:0, price:0})
                }else {
                    this.$message({
                        message: '最多只能添加三条',
                        type: 'warning'
