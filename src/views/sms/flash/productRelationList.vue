        ...
        <div class="table-container">
            <el-table ref="productRelationTable"
                ...
                <el-table-column label="货号" width="140" align="center">
                    <template slot-scope="scope">{{scope.row.product.productSn}}</template>
                </el-table-column>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            handleDialogCurrentChange(value){
                this.dialogData.listQuery.pageNum=value;
                this.getDialogList();
            },
            handleDialogSizeChange(value){
                this.dialogData.listQuery.pageNum=1;
                this.dialogData.listQuery.pageSize=value;
                this.getDialogList();
            },
