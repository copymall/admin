    ...
    <div class="app-container">
        <el-card class="filter-container" shadow="never">
            <div>
                ...
                <span>筛选搜索</span>
                <el-button @click="handleSearchList()" style="float:right" type="primary" size="small">查询搜索</el-button>
                <el-button @click="handleResetSearch()" style="float:right; margin-right: 15px" size="small">重置
                </el-button>
            </div>
        ...
        <div class="batch-operate-container">
            ...
            <el-button @click="handleBatchOperate()" style="margin-left: 20px" class="search-button" type="primary"
                       size="small">确定
            </el-button>
        </div>
        ...
        <el-dialog title="设置排序" :visible.sync="sortDialogVisible" width="40%">
            ...
            <span slot="footer">
                ...
                <el-button @click="handleUpdateSort" type="primary" size="small">确 定</el-button>
            </span>
        </el-dialog>
