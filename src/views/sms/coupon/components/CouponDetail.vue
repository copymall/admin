    ...
    <el-card class="form-container" shadow="never">
        <el-form ref="couponFrom"
            ...
            <el-form-item label="有效期：">
                <el-date-picker v-model="coupon.startTime" type="date" placeholder="选择日期" style="width: 150px"></el-date-picker>
                <span>至</span>
                <el-date-picker v-model="coupon.endTime" type="date" placeholder="选择日期" style="width: 150px"></el-date-picker>
            </el-form-item>
            ...
            <el-form-item v-show="coupon.useType === 1">
                <el-cascader clearable
                             ...
                             placeholder="请选择分类名称"></el-cascader>
