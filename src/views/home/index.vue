<template>
    <div class="app-container">
            ...
            <el-row :gutter="20">
                <el-col :span="6">
                    <div class="out-border">
                        ...
                        <a href="https://github.com/copymall/admin">项目地址</a>
                        </div>
                    </div>
                </el-col>
                <el-col :span="6">
        ...
        <el-card class="mine-layout">
            ...
            <img src="http://macro-oss.oss-cn-shenzhen.aliyuncs.com/mall/banner/qrcode_for_macrozheng_258.jpg" width="150px" height="150px">
            </div>
